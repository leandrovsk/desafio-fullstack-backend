...
contactsRoutes.patch("/:id", ensureTokenIsValidMiddleware, ensureContactIdExistsMiddleware, ensureUserIsOwnerMiddleware, ensureDataIsValid(contactSchemaUpdate), ensureEmailNotExistsMiddleware, updateContactController)
contactsRoutes.delete("/:id", ensureTokenIsValidMiddleware, ensureContactIdExistsMiddleware, ensureUserIsOwnerMiddleware, deleteContactController)
